    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Contraseña ha sido actualizada."
        ...
        //[ExcludeFilter(typeof(CustomAuthorizeAttribute))]
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "PLD :: Contraseña Actualizada", "La contraseña de la cuenta <strong>" + user.UserName + "</strong> ha sido actualizada.<br/><br/>Nueva Contraseña: <strong>" + model.NewPassword + "</strong><br/>");
                R = new ResultadoModels { NotifyMsg = "Contraseña actualizada. Se ha enviado un correo al usuario con la nueva contraseña.", NotifyType = Enums.eNotify_Type.success };
